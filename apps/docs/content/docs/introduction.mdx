...
- **31 built-in detectors** — emails, phones, government IDs, financial data, secrets, and more
- **Global coverage** — detectors for Nigeria, India, US, UK, South Africa, Indonesia, Brazil, Canada, and other regions
- **Region filtering** — scope detection to specific countries with the `regions` option
